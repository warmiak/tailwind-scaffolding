@if (session('success'))
    <div class="container mx-auto">
        <div class="flex bg-green-lighter my-4">
            ...
            <div class="w-auto text-grey-darker flex items-center p-4">
...
@if (session('info'))
    <div class="container mx-auto">
        <div class="flex bg-teal-lighter my-4">
            ...
            <div class="w-auto text-grey-darker flex items-center p-4">
                <p class="leading-tight">{{ session('info') }}</p>
            </div>
        </div>
    </div>
@endif
@if (session('warning'))
    <div class="container mx-auto">
        <div class="flex bg-yellow-lighter my-4">
            ...
            <div class="w-auto text-grey-darker flex items-center p-4">
                <p class="leading-tight">{{ session('warning') }}</p>
            </div>
        </div>
    </div>
@endif
@if (session('danger'))
    <div class="container mx-auto">
        <div class="flex bg-red-lighter my-4 shadow-lg">
            ...
            <div class="w-auto text-black flex items-center p-4">
                <p class="leading-tight">{{ session('danger') }}</p>
            </div>
        </div>
    </div>
@endif