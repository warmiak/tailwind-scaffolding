...
<div class="container mx-auto">
    ...
    <div class="flex -mx-2 my-8">
        ...
        <div class="max-w-md w-full lg:flex mx-2 shadow">
        ...
        <div class="max-w-md w-full lg:flex mx-2 shadow">
            <wysiwyg :editorheight="240"></wysiwyg>
        </div>
...
<div class="flex justify-between container mx-auto my-8">
    <div class="max-w-xs rounded overflow-hidden shadow my-2">
