...
Vue.component('edit-permission', require('./components/EditPermission'));
Vue.component('edit-account', require('./components/EditAccount'));
Vue.component('edit-avatar', require('./components/EditAvatar'));
Vue.component('edit-role', require('./components/EditRole'));
